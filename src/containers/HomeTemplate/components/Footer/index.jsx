      ...
      >
        ...
        <Grid container className="footer__list">
          ...
          <Grid item xs={12} lg={3} md={12} className="footer__list-item  list--social">
            ...
            <a className="footer__list-link" href="https://www.facebook.com/lophocviet/">
            ...
            <a className="footer__list-link" href="https://www.youtube.com/watch?v=rLjqI-jnaGI">
        ...
        <p className="footer__rights pt-5 pb-5">CyberSoft - All rights reserved</p>
      </Grid>
    </footer>
  );
}
